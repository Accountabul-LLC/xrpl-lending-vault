...
export const SNAPSHOTS: Record<string, LabViewState> = {
  ...
  vaultCreated: base({
    ...
    vault: {
      vaultId: VAULT_ID,
      account: OWNER,
      shareMptId: '00000A1B2C3D4E5F60718293A4B5C6D7',
      asset: 'XRP',
      assetsTotal: '0',
      assetsAvailable: '0',
      assetsMaximum: '100000',
  ...
  loanActive: base({
    ...
    loan: {
      ...
      totalValueOutstanding: '10548',
      interestRate: 10000,
      nextPaymentDueDate: 'Month 1',
      paymentRemaining: 12,
      flags: 0,
      defaulted: false,
      impaired: false
  ...
  paid: base({
    ...
    loan: {
      loanId: LOAN_ID,
      borrower: BORROWER,
      principalOutstanding: '9204',
      totalValueOutstanding: '9669',
      interestRate: 10000,
      nextPaymentDueDate: 'Month 2',
      paymentRemaining: 11,
      flags: 0,
      defaulted: false,
      impaired: false
