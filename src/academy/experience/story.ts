...
export const STORY_STEPS: StoryStep[] = [
  {
    ...
    camera: { position: [1.6, 4.8, 11.2], lookAt: [0, 1.15, 0] }
  },
  {
    id: 2,
    ...
    camera: { position: [0.5, 5.0, 12.0], lookAt: [0, 1.2, 0] }
  },
  {
    id: 3,
    ...
    camera: { position: [-3.0, 4.6, 11.0], lookAt: [0, 1.1, 0] }
  },
  {
    id: 4,
    ...
    focus: ['vault'],
    camera: { position: [0.1, 5.4, 12.4], lookAt: [0, 1.2, 0] }
  },
  {
    id: 5,
    ...
    camera: { position: [-2.8, 4.6, 11.0], lookAt: [0, 1.1, 0] }
  },
  {
    id: 6,
    ...
    camera: { position: [0.3, 5.4, 12.4], lookAt: [0, 1.15, 0] }
  },
  {
    id: 7,
    title: 'Fund the Loan',
    ...
    camera: { position: [1.4, 5.0, 12.0], lookAt: [0, 1.1, 0] }
  },
  {
    id: 8,
    ...
    camera: { position: [-1.6, 4.4, 10.4], lookAt: [0, 1.15, 0] }
  },
  {
    id: 9,
    ...
    focus: ['borrower', 'vault'],
    camera: { position: [0.6, 5.2, 12.2], lookAt: [0, 1.1, 0] }
  },
  {
    id: 10,
    ...
    focus: ['depositor', 'vault'],
    camera: { position: [-2.6, 4.8, 11.4], lookAt: [0, 1.1, 0] }
  }
]
