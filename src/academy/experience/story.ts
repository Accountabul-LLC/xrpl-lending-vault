...
export const STORY_STEPS: StoryStep[] = [
  {
    ...
    camera: { position: [1.4, 12.8, 10.8], lookAt: [0, 0.4, 0] }
  },
  {
    id: 2,
    ...
    camera: { position: [0.4, 13.2, 11.0], lookAt: [0, 0.35, 0] }
  },
  {
    id: 3,
    ...
    camera: { position: [-2.8, 12.8, 10.6], lookAt: [0, 0.35, 0] }
  },
  {
    id: 4,
    ...
    focus: ['vault'],
    camera: { position: [0.15, 13.6, 11.2], lookAt: [0, 0.3, 0] }
  },
  {
    id: 5,
    ...
    camera: { position: [-2.6, 12.8, 10.8], lookAt: [0, 0.35, 0] }
  },
  {
    id: 6,
    ...
    camera: { position: [0.3, 13.4, 11.2], lookAt: [0, 0.35, 0] }
  },
  {
    id: 7,
    title: 'Fund the Loan',
    ...
    camera: { position: [1.2, 13.0, 11.0], lookAt: [0, 0.35, 0] }
  },
  {
    id: 8,
    ...
    camera: { position: [-1.5, 12.4, 10.4], lookAt: [0, 0.4, 0] }
  },
  {
    id: 9,
    ...
    focus: ['borrower', 'vault'],
    camera: { position: [0.5, 13.2, 11.0], lookAt: [0, 0.35, 0] }
  },
  {
    id: 10,
    ...
    focus: ['depositor', 'vault'],
    camera: { position: [-2.4, 12.8, 10.8], lookAt: [0, 0.35, 0] }
  }
]
...
export function stepHasMotion(step: number): boolean {
  return step === 3 || step === 5 || step === 6 || step === 7 || step === 9 || step === 10
}
